...
public class BookMyDoctorControllerAdvice {
	...
	public ValidationResponse globalHandleException(Exception e) {
	
		 ValidationResponse response = new  ValidationResponse();
		 response.setMessage("Anable to do process");
		 response.setDescription("Please check the details you entered");
		 return response;
	}
